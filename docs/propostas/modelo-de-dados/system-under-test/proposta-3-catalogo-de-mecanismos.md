...
|-----------------------|---------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------|
| `resource`            | `INSERT` do estado inicial e um `UPDATE` por commit                                                                       | o oráculo exato: `value_inicial` e `value_final`                                                                         |
...
projetor nunca escreve `resource`, e por isso não move `value_inicial` nem `value_final`.
