...
`value_inicial` e `value_final` venham da mesma fonte. A distinção só passou a existir
depois que o
...
ainda diz que o oráculo "lê `value_inicial` antes do primeiro worker". Fechar uma das
