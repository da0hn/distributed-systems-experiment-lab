...
| P10 | Que tipo o evento de bloqueio do buffer carrega? O conjunto de tipos do log é fechado em quatro valores, e nenhum deles nomeia este bloqueio.                                                    | [ADR-0017](../../adr/0017-a-persistencia-antecipada-do-log-de-observacoes-e-o-buffer-que-a-alimenta.md#negativas) |
