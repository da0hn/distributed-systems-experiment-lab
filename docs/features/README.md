...
|----------------------------------------------------|-------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------|
| `R18` de `deteccao-de-atualizacao-perdida`         | de onde vem `value_inicial`, já que a única evidência era o arquivo congelado | [`E-86`](../fila-de-decisoes.md#e-86-fecha-em-o-estado-inicial-é-escrito-com-a-captura-aberta-escolhida-em-2026-08-12)          |
...
consolidado que o stream de CDC já entregou a qualquer um dos dois oráculos, pelo fecho de
[`E-96`](../fila-de-decisoes.md#e-96-fecha-em-card-e-example-mapping-sem-adr-escolhida-em-2026-08-13),
sem ADR.
