...
| R4 | Abrir o stream de uma execução encerrada DEVE devolver o histórico completo e DEVE fechar o stream, sem aguardar evento ao vivo que não virá.                                                                                                                                | [`E-88`, o sinal de encerramento](../../adr/fila-de-decisoes.md#e-88--o-sinal-de-encerramento-do-stream-que-a-r4-de-streaming-propõe-sem-adr); nenhum ADR aceito o decide, e `R4` é proposta deste card                                                                                        | pendente              |
