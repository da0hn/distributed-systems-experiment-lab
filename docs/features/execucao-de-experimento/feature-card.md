...
| R3  | Na calibração, `commits` **DEVE** igualar `final_value − initial_value`. Divergindo, a plataforma **DEVE** recusar o relatório.                                                                                                                                                                                                                                                                                                                                                                             | [ADR-0002, A calibração do denominador](../../adr/0002-o-dominio-minimo-e-os-dois-oraculos.md#a-calibração-do-denominador)                                                                                                                                                                                       | pessoa, em 2026-08-12 |
