...
| R3  | Na calibração, `commits` **DEVE** igualar `value_final − value_initial`. Divergindo, a plataforma **DEVE** recusar o relatório.                                                                                                                                                                                                                                                                                                                                                                             | [ADR-0002, A calibração do denominador](../../adr/0002-o-dominio-minimo-e-os-dois-oraculos.md#a-calibração-do-denominador)                                                                                                                                                                                       | pessoa, em 2026-08-12 |
