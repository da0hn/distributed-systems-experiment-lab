...
| P3 | `allocate` lê a soma e compara com `capacity`. Quando o predicado reprova, a operação reporta sucesso ou falha ao Lab Plane? A distinção afeta `commits − successes`.           | nova, 2026-08-01                                                                              |
