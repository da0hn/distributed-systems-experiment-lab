...
| R7  | O mesmo experimento **DEVE** ser comparado sob `READ COMMITTED`, `REPEATABLE READ` e `SERIALIZABLE`. Só o terceiro aborta uma das transações, com SQLSTATE `40001`.                                   | decisão da pessoa, sem ADR; o `ADR-0002` recusa decidir o nível de isolamento por escrito                                                                                                                          | pessoa, em 2026-08-12 |
| R8  | A contiguidade da sequência de LSN **DEVE** ser conferida antes da soma, no consumidor do broker. Um buraco **DEVE** invalidar a execução com o rótulo `fonte incompleta`, e nenhum veredito sai.     | [ADR-0013, Decisão](../../adr/0013-a-proveniencia-da-fonte-como-criterio-da-proibicao-do-oraculo.md#decisão)                                                                                                       | pessoa, em 2026-08-12 |
| R9  | O oráculo **DEVE** somar até reconhecer no stream o evento da marca de fim, escrita pelo sistema medido fora da janela medida. O estouro do limite de espera produz `fonte atrasada`, e não veredito. | decisão da pessoa: sem a marca de fim, o oráculo emitiria veredito sobre uma soma parcial                                                                                                                          | pessoa, em 2026-08-12 |
