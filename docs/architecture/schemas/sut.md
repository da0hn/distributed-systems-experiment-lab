...
| `bigint` nativo em `value`, `capacity`, `amount` | as três colunas são `bigint`, um tipo só nas três; o argumento pela escolha e as alternativas descartadas vivem só na linha da fila, ao lado                                                                                                                                                                                                                                                                    | [`E-56`, fecho](../../adr/fila-de-decisoes.md#e-56-fecha-em-bigint-nas-três-escolhida-em-2026-08-13)                                                                                                               |
