...
([`schemas/README.md`](../../../README.md#a-ausência-de-linha-entre-os-dois-diagramas-é-a-decisão)). A
...
|----------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ordem de coluna na chave                           | não há ordem a decidir: a chave é `execution_id` sozinho, e o UUIDv7 põe toda inserção no fim da B-tree, como do lado medido                                      | [`schemas/sut.md`](../../../sut.md#o-que-o-diagrama-do-sut-não-desenha)                                                                                                                           |
...
| ausência de chave estrangeira                      | nenhuma poderia existir: o único candidato mora no outro schema, e a linha entre os dois renderiza a fronteira proibida                                           | [ADR-0010](../../../../../adr/0010-a-fronteira-de-schema-e-o-cdc-como-fonte-do-veredito.md#decisão) e [`schemas/README.md`](../../../README.md#a-ausência-de-linha-entre-os-dois-diagramas-é-a-decisão) |
...
| O comando que abre uma execução carrega a definição inteira, e o `lab-plane` nunca lê o banco do `lab-journal`. | o `lab-plane` busca a definição por identificador, no outro serviço    | entra uma coluna com o identificador da definição, e nasce uma travessia de rede que a [matriz](../../../../integrations.md#matriz) não tem hoje                                                                              |
...
- **Onde a definição de experimento vive.** O
  [dono da forma do `lab_plane`](../../../lab-plane.md#o-que-o-diagrama-do-lab_plane-não-desenha) registra a
...
- **O contrato do comando de execução, e o formato do relatório**, sem forma em
  [`Q-INT-1`](../../../../integrations.md#perguntas-em-aberto). A suposição de que o comando carrega a definição
