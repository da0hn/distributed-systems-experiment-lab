...
[matriz](../../../../integrations.md#matriz).

## O que o WAL destas duas tabelas dá ao oráculo

| Evento no WAL                             | O que o oráculo extrai                                       | Evidência                                                                                                                                          |
|-------------------------------------------|--------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|
| `INSERT` de `resource`, fora da janela    | `initial_value`, a `capacity` declarada, e a partição existe | [ADR-0010](../../../../../adr/0010-a-fronteira-de-schema-e-o-cdc-como-fonte-do-veredito.md#decisão)                                                      |
| `UPDATE` de `resource.value`              | a série inteira de valores; o último é `final_value`         | [ADR-0010](../../../../../adr/0010-a-fronteira-de-schema-e-o-cdc-como-fonte-do-veredito.md#decisão)                                                      |
...
([matriz](../../../../integrations.md#matriz)). Salto legítimo e buraco ficam
