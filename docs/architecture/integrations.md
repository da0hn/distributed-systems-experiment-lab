...
| `lab-plane`               | `system-under-test`                                                              | consulta de confirmação, depois da quiescência, fora da janela medida | confirmar o consolidado por recurso, e detectar divergência com o stream de CDC | `decidido/não implementado` — decidida sem ADR, em 2026-08-13; nenhum código, rota nem contrato existe | nenhum; forma não decidida    | [feature-card.md, Regras de negócio](../features/deteccao-de-divergencia-entre-fontes/feature-card.md#regras-de-negócio); [card](../features/deteccao-de-divergencia-entre-fontes/feature-card.md)                                                                                  |
