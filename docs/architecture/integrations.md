...
| `system-under-test`       | `lab-plane`                                                                      | callback HTTP, disparado e esquecido, fora da janela medida                  | avisar que o processo medido terminou, disparando a consulta de confirmação                     | `decidido/não implementado` — decidida sem ADR, em 2026-08-14; tensiona a letra do ADR-0008, sem resolução; nenhum código existe | nenhum; forma não decidida    | [feature-card.md, Regras de negócio](../features/deteccao-de-divergencia-entre-fontes/feature-card.md#regras-de-negócio); tensiona [ADR-0008](../adr/0008-os-dois-planos-em-processos-separados.md#decisão)                                                                         |
