...
essa regra ao oráculo exato: `initial_value` e `final_value` deixaram de vir de um
...
- O oráculo exato não muda: `initial_value` e `final_value` continuam vindo do `INSERT`
