...
essa regra ao oráculo exato: `value_inicial` e `value_final` deixaram de vir de um
...
- O oráculo exato não muda: `value_inicial` e `value_final` continuam vindo do `INSERT`
