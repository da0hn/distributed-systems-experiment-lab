...
| `D-ARQ-12` | Maven contra Gradle                      | emendar a ADR 0017 do homelab para Maven          | [`../architecture/entrega-continua.md`](../architecture/entrega-continua.md)         |
...
| `D-ARQ-15` | a forma do `deploy/` no primeiro commit  | `deploy/` mínimo agora, uma réplica               | [`../architecture/entrega-continua.md`](../architecture/entrega-continua.md)         |
| `D-ARQ-14` | o que o pipeline executa                 | só guardas e provas; experimento sob demanda      | [`../architecture/entrega-continua.md`](../architecture/entrega-continua.md)         |
