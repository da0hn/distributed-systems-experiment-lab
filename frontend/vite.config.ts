...
// `/api` sai daqui, e quem sabe o mapa e o outro lado.
//
...
// tres sintaxes; hoje a reparticao entre os servicos esta no `application.yml`
// do gateway, e o mesmo processo a executa nos dois ambientes. Este arquivo
// nao carrega mais rota.
